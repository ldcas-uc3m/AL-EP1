...
% - LOPDPGDD art. 11.2
\subsection{La política de privacidad}
...
En este caso, como podemos ver en la \figref{ubicacion_politica}, los enlaces a las políticas de privacidad y de \textit{cookies} aparecen en \textit{footer} de la página, bajo la sección \textit{ENLACES LEGALES}. Éste lugar no es uno de los más visibles de toda la página, pero es claramente legible y de un tamaño similar al resto de la página.
